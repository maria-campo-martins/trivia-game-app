...
//  Trivia
//
//  Created by Maria Campo Martins on 2023-07-11.
//
...
class TriviaManager: ObservableObject {
    ...
    func setQuestion() {
        ...
        if index < length {
            let currentTQuestion = trivia[index]
            question = currentTQuestion.formattedQuestion
            answerChoices = currentTQuestion.answers
        }
    }
